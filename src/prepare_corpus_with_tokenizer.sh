...
# Include the first text from the first 9 files from newspaper corpus
...
echo "Tokenizing ../data/$OUTPUT_TRAIN.en"
python ./tokenizer.py -mode batch -unit jaso -input_path ../data/$OUTPUT_TRAIN.en -output_path ../data/$OUTPUT_TRAIN.tok.en 
echo "Tokenizing ../data/$OUTPUT_TRAIN.fr"
python ./tokenizer.py -mode batch -unit jaso -input_path ../data/$OUTPUT_TRAIN.fr -output_path ../data/$OUTPUT_TRAIN.tok.fr 
echo "Tokenizing ../data/$OUTPUT_VALIDATE.en"
python ./tokenizer.py -mode batch -unit jaso -input_path ../data/$OUTPUT_VALIDATE.en -output_path ../data/$OUTPUT_VALIDATE.tok.en 
echo "Tokenizing ../data/$OUTPUT_VALIDATE.fr"
python ./tokenizer.py -mode batch -unit jaso -input_path ../data/$OUTPUT_VALIDATE.fr -output_path ../data/$OUTPUT_VALIDATE.tok.fr 
echo "Tokenizing ../data/$OUTPUT_TEST.en"
python ./tokenizer.py -mode batch -unit jaso -input_path ../data/$OUTPUT_TEST.en -output_path ../data/$OUTPUT_TEST.tok.en 
echo "Tokenizing ../data/$OUTPUT_TEST.fr"
python ./tokenizer.py -mode batch -unit jaso -input_path ../data/$OUTPUT_TEST.fr -output_path ../data/$OUTPUT_TEST.tok.fr 